...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__01_content_templates_sidebar__ = __webpack_require__(42);
/**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__plugin_scss__ = __webpack_require__(89);
...
var BlockLayoutsSidebar = function (_React$Component) {
    __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_inherits___default()(BlockLayoutsSidebar, _React$Component);

    function BlockLayoutsSidebar() {
        var _ref;

        var _temp, _this, _ret;

        __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_classCallCheck___default()(this, BlockLayoutsSidebar);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_possibleConstructorReturn___default()(this, (_ref = BlockLayoutsSidebar.__proto__ || __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_get_prototype_of___default()(BlockLayoutsSidebar)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
    ...
    __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(BlockLayoutsSidebar, [{
        ...
        value: function componentDidMount() {
            ...
            var path = '/wp/v2/block-layout?post_type=' + currentPostType;
            apiRequest({ path: path }).then(function (posts) {
                console.log('posts', posts);
                _this2.onNewPosts(posts);
            });

            if ("block-layout" !== currentPostType) {
                // don't show initial popup on new block layout screen
        ...
        key: 'openInitialPopup',
        value: function openInitialPopup() {
        ...
        key: 'onNewPosts',
        value: function onNewPosts(posts) {

            var templates = posts.map(function (post) {
        ...
        key: 'saveInsertedTemplate',
        value: function saveInsertedTemplate() {
            var blocks = select("core/editor").getBlocks();
            var templateBlocksContent = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(blocks);
            this.setState({ templateBlocksContent: templateBlocksContent });
        }
        ...
        key: 'isUnchangedTemplate',
        value: function isUnchangedTemplate() {
            var blocks = select("core/editor").getBlocks();
            var templateBlocksContent = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(blocks);
        ...
        key: 'createTemplateSelectedNotice',
        value: function createTemplateSelectedNotice(template) {
            dispatch('core/notices').createNotice('info', template.title + ' ' + __('Template selected', 'block-layouts'), {
                isDismissible: true,
                type: 'snackbar'
            });
        }
        ...
        value: function noLayoutsFound() {
            return wp.element.createElement(
                ...
                wp.element.createElement(
                    'h2',
                    null,
                    __("No Layouts Found", "block-layouts")
                ),
                wp.element.createElement(
                    'p',
                    null,
                    __("You don't have any Layouts", "block-layouts")
                ),
                wp.element.createElement(
                    'a',
                    { href: templatesAdminLink },
                    __("Please create a new Template first.", "block-layouts")
                )
            );
        }
        ...
        value: function render() {
            ...
            var _state = this.state,
                ...
                isInitialPopupOpen = _state.isInitialPopupOpen;
            ...
            return wp.element.createElement(
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(
                        PanelBody,
                        { title: __("Select a Template", "block-layouts"), opened: true },
                        wp.element.createElement(
                            PanelRow,
                            null,
                            wp.element.createElement(
                                'ul',
                                { className: 'block-layout-button-list' },
                                    ...
                                    return wp.element.createElement(
                                        ...
                                        wp.element.createElement(
                                            ...
                                            { isDefault: true, onClick: function onClick() {
                                                    _this3.onSelectTemplate(template);
                                                }, className: 'template-button' },
                                            wp.element.createElement('img', { src: template.icon, width: '40' }),
                                            template.title
                                        )
                                    );
                                }) : this.noLayoutsFound()
                ...
                isOpen && wp.element.createElement(
                    ...
                    wp.element.createElement(
                        ...
                        { isPrimary: true, onClick: function onClick() {
                                _this3.onSelectTemplate(_this3.state.selectedTemplate, true);
                            } },
                        __("Overwrite Content", "block-layouts")
                    )
                ),
                isInitialPopupOpen && templates.length > 0 && wp.element.createElement(
                    Modal,
                    {
                        title: 'Choose a template',
                        onRequestClose: function onRequestClose() {
                            return _this3.setState({ isInitialPopupOpen: false });
                        } },
                    wp.element.createElement(
                        'ul',
                        { className: 'block-layout-button-list' },
                        templates.length > 0 ? templates.map(function (template) {
                            return wp.element.createElement(
                                ...
                                wp.element.createElement(
                                    Button,
                                    { isDefault: true, onClick: function onClick() {
                                            _this3.setState({ isInitialPopupOpen: false });_this3.onSelectTemplate(template);
                                        }, className: 'template-button' },
                                    wp.element.createElement('img', { src: template.icon, width: '40' }),
                                    template.title
                                )
                    ...
                    wp.element.createElement(
                        Button,
                        { isDefault: true, style: { width: '100%', textAlign: 'center', display: 'block' }, onClick: function onClick() {
                                _this3.setState({ isInitialPopupOpen: false });
                            } },
