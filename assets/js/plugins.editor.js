...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_TemplateSelectModal__ = __webpack_require__(517);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__plugin_scss__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__plugin_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__plugin_scss__);
...
var supportedPostTypes = derweiliBlockLayoutsSupportedPostTypes;
...
var BlockLayoutsSidebar = function (_React$Component) {
    ...
    __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(BlockLayoutsSidebar, [{
        ...
        value: function componentDidMount() {
            ...
            var isNewPost = this.props.isNewPost;
        ...
        value: function saveInsertedTemplate() {
            var blockInEditor = this.props.blockInEditor;

            var templateBlocksContent = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(blockInEditor);
        ...
        value: function render() {
            ...
            var _state = this.state,
                ...
                temporarilySelectdTemplate = _state.temporarilySelectdTemplate;
            var postType = this.props.postType;
            ...
            return wp.element.createElement(
                ...
                isInitialPopupOpen && templates.length > 0 && wp.element.createElement(__WEBPACK_IMPORTED_MODULE_6__components_TemplateSelectModal__["a" /* default */], {
                    templates: templates,
...
var BlockLayoutsSidebarWithSelect = withSelect(function (select, ownProps) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_slicedToArray__ = __webpack_require__(518);
...
var TemplateSelectModal = function TemplateSelectModal(_ref) {
    var templates = _ref.templates,
        onSelectTemplate = _ref.onSelectTemplate,
    ...
    var switchTemplate = function switchTemplate(id) {
    ...
    return wp.element.createElement(
        ...
        wp.element.createElement(SelectControl, {
            ...
            options: [{ label: 'Select', value: null }].concat(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_toConsumableArray___default()(templates.map(function (template) {
                return {
            ...
            onChange: function onChange(id) {
                switchTemplate(parseInt(id));
            }
        }),
        selectedTemplate !== null && selectedTemplate.icon && wp.element.createElement('img', { src: selectedTemplate.icon, alt: '' }),
        wp.element.createElement(
            Button,
...
/* harmony default export */ __webpack_exports__["a"] = (TemplateSelectModal);
...
var _isIterable2 = __webpack_require__(519);
